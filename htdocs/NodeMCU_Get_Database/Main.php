  ...
  <body>
	...
	<div id="userModal" class="modal">
	  <div class="modal-content">
		...
		<form id="userForm" action="adicionar_usuario.php" method="post">
		  Nome: <input type="text" name="nome" class="input_nome"><br><br>
		  <input title="INSERT INTO usuarios (nome) VALUES (var)" type="submit" value="Adicionar" class="button">
		</form>
	  </div>
	</div>
